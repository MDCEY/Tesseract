SELECT count(Part_Num) 'Total',isnull(Part_Desc, Prod_Desc) 'Description',
       MAX(Call_InDate) 'LastIn' FROM COOPESOLBRANCHLIVE.dbo.SCCall 
...
ORDER BY [LastIn] DESC, [Description]